<?php
class ControllerModuleImageChecker extends Controller
{
	...
	{
		$this->load->language("module/imagechecker");
		...
		$this->response->setOutput($this->load->view('module/imagechecker.tpl',$data));
	}
}
?>